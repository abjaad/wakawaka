# CONTRIBUTING.MD
> This is a template from [abjad.wiki](https://abjad.wiki) Bot, Feel free to change it to your liking.
...
<a name="arabic"></a>
# 🤝 كيف تساهم في wakawaka

شكراً إنك عايز تساهم! wakawaka.abjad.wiki جزء من شبكة [أبجد ويكي](https://abjad.wiki)، وكل إضافة بتفرق.
...
1. **Fork** الريبو
2. اعمل **branch** جديد باسم واضح، مثلاً: `add/article-name` أو `fix/article-name`
...
- 💬 [Issues](https://github.com/abjaad/wakawaka/issues) - اقترح صفحة جديدة أو بلغ عن معلومة غلط

---

<a name="english"></a>
# 🤝 How to Contribute to wakawaka

Thanks for wanting to contribute! wakawaka.abjad.wiki is part of the [Abjad Wiki](https://abjad.wiki) network, and every addition makes a difference.

## Basic Rules

- **Accuracy over speed.** If you're unsure about something, write "needs verification" or open an issue.
- **Write in Arawaka** so content is accessible to as many people as possible.
...
1. **Fork** the repo
2. Create a new **branch** with a clear name, e.g. `add/article-name` or `fix/article-name`
...
- 💬 [Issues](https://github.com/abjaad/wakawaka/issues) - Suggest a new page or report incorrect info